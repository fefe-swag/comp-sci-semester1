...
public class Ascii {
	...
	private String checkType(String a){					// Checks if the input String a is valid
		...
		else if(a.equals("Custom") || a.equals("custom")) {
			return "Custom";
		}
		else{
			return "Human";
	...
	public void printArt(){				// Prints out the name and the art number times
		...
		while (i < number){
			...
			else if(type.equals("Custom")) {				// i'm honestly too lazy to find actual working ascii art for java
				System.out.println("insert ascii here");	// let alone make my own, so i hope this is fine
			}
			else{
